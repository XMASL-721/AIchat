...
基于 **Spring Boot 3.4.1 + Vue 3** 的全栈健身 AI 应用，集成 Spring AI 大模型，提供智能问答、减脂餐食谱、健身训练、健康资讯、补剂指南、AI 个性化计划生成等功能。
...
| 🎯 AI 计划生成 | 根据用户身体数据生成个性化饮食/训练/综合计划（SSE 流式） |
